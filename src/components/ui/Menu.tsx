...
export const menu = tv({
  slots: {
    menuPopover:
      "entering:animate-fade exiting:animate-fadeOut overflow-auto rounded-xl border-2 border-border bg-panel shadow-xl ring-4 ring-border",
    header: "p-2",
...
const MenuContent = <T extends object>({
  ...
  // @ts-expect-error - This kinda works but popover is no longer used in menu in newer versions
