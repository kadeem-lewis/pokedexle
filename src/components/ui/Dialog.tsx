...
const dialog = tv({
  slots: {
    ...
    modal:
      "relative max-h-full w-full max-w-xl rounded-lg border-4 border-white bg-panel bg-clip-padding text-left align-middle text-fg shadow-2xl ring-8 ring-border dark:backdrop-blur-2xl dark:backdrop-saturate-200 forced-colors:bg-[Canvas]",
    content:
      "relative max-h-[inherit] overflow-auto overflow-y-auto p-6 outline-0 before:absolute before:inset-0 before:z-[-1] before:bg-[url('/svgs/pokeball-hollow.svg')] before:bg-contain before:bg-center before:bg-no-repeat before:bg-origin-content before:px-4 before:py-1 [[data-placement]>&]:p-4",
  },
});
