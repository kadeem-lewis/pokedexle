...
const switchVariants = tv({
  slots: {
    ...
    indicator:
      "bg-surface-3 h-6 w-10 cursor-pointer rounded-2xl duration-200 before:mx-0.5 before:mt-0.5 before:block before:h-5 before:w-5 before:rounded-2xl before:bg-white before:transition-all",
    label: "text-fg-3",
  },
  variants: {
    selected: {
